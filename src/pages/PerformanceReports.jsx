        ...
        <div className="container-fluid" style={{ width: "100%", }}>
            <div className="row">
                ...
                {/* <div className="col-md-2 sidebar">
                    <h4 className="brand">FinSage ERP</h4>
                    <ul className="nav flex-column">
                        <li className="nav-item">Dashboard</li>
                        <li className="nav-item">Team Management</li>
                        <li className="nav-item">Assign Task</li>
                        <li className="nav-item">Team Managers</li>
                        <li className="nav-item">Administrative Control</li>
                        <li className="nav-item active">Performance Reports</li>
                    </ul>
                </div> */}
                ...
                <div className="col-md-10 main-content">
                    <div className="content-wrapper">
                        ...
                        <div className="button-container">
                            ...
                            <div>
                                <Button variant="dark" className="me-2">Previous</Button>
